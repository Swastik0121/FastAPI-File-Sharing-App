...
async def upload_file(
    ...
    try:
        ...
        if upload_result.response_metadata.http_status_code == 200:
            ...
            await session.refresh(post) # to add details to the database which were not specified earlier like time and id.
...
async def delete_post(post_id: str, 
    ...
    try:
        ...
        if post.user_id != user.id: # type: ignore
            raise HTTPException(status_code=403, detail="You don't have the permission to delete the post.")
